#
#  Be sure to run `pod spec lint semo-content-ios.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "semo-content-ios"
  s.version      = "0.0.1"
  s.summary      = "Semo content platform for iOS"
  ...
  s.description  = <<-DESC
    Semo content platform.
    Provides integration with the semo-wp plugin for Wordpress.
                 DESC

  s.homepage     = "https://github.com/innerfunction/semo-content-ios"
